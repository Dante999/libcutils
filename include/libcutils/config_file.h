...
Result config_file_init(const char *filepath);
void   config_file_print(void);

const char *config_file_gets(const char *key);
int         config_file_geti(const char *key);

/* *****************************************************************************
 * Implementation
 ******************************************************************************/
#ifdef CONFIG_FILE_IMPLEMENTATION
...
#endif // CONFIG_FILE_IMPLEMENTATION
